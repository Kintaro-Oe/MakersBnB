...
CREATE TABLE requests (id serial PRIMARY KEY, user_request_id INTEGER REFERENCES user_requests(user_request_id), property_id INTEGER REFERENCES property_requests(property_request_id), status VARCHAR (30) DEFAULT 'pending');
